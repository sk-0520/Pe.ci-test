...
foreach($platform in $Platforms) {
    $targetPath = Join-Path $ReleaseDirectory ("Pe_" + $vesion + "_" + $platform + ".zip")
...
ConvertTo-Json -InputObject $updateJson | Out-File $outputUpdateFile -Encoding utf8 -Force | Get-Content
