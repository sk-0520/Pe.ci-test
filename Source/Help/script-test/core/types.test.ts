import * as types from '../../script/core/types';
...
describe('types', () => {
	test.each([
		...
		[false, Symbol()],
		[false, 1],
		//<bigint>[false, 9007199254740991n],
		[false, 'A'],
		[false, true],
		[false, ['A']],
		[false, { a: 'A' }],
	...
	test.each([
		...
		//<bigint>[false, inputObject, 'bigint'],
	...
	test.each([
		...
		[false, inputObject, 'symbol'],
		[false, inputObject, 'number'],
		//<bigint>[true, inputObject, 'bigint'],
		[false, inputObject, 'string'],
		[false, inputObject, 'boolean'],
		[false, inputObject, 'array'],
		[false, inputObject, 'object'],
	...
	test.each([
		...
		//<bigint>[9007199254740991n, inputObject, 'bigint', 9007199254740991n],
