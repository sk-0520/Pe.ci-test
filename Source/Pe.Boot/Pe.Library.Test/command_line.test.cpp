...
namespace PeLibraryTest
{
    ...
    public:
        TEST_METHOD(parse_command_line_with_command_test)
        {
            ...
            COMMAND_LINE_OPTION actual1_1 = parse_command_line(&input1, false);
            ...
            COMMAND_LINE_OPTION actual1_2 = parse_command_line(&input1, true);
            ...
            TEXT input2 = wrap("");
            COMMAND_LINE_OPTION actual2_1 = parse_command_line(&input2, false);
            Assert::AreEqual((size_t)0, actual2_1.count);
            Assert::IsNull(actual2_1.library.command);
            free_command_line(&actual2_1);

            COMMAND_LINE_OPTION actual2_2 = parse_command_line(&input2, true);
