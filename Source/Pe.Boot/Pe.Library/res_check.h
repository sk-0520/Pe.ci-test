...
#define RES_CHECK_ARG_FILE caller_file
#define RES_CHECK_ARG_LINE caller_line
#define RES_CHECK_WRAP_ARGS FUNCTION, RELATIVE_FILET, (__LINE__)
#define RES_CHECK_FUNC_ARGS const TCHAR* RES_CHECK_ARG_FUNC, const TCHAR* RES_CHECK_ARG_FILE, size_t RES_CHECK_ARG_LINE
#define RES_CHECK_CALL_ARGS RES_CHECK_ARG_FUNC, RES_CHECK_ARG_FILE, RES_CHECK_ARG_LINE
