...
{
    public class CustomizeLauncherEmbeddedViewModel : CustomizeLauncherDetailViewModelBase
    {
        public CustomizeLauncherEmbeddedViewModel(CustomizeLauncherItemElement model, ILoggerFactory loggerFactory)
