// <auto-generated>
// [T4] build 2024-04-07 10:12:17Z(UTC)
// </auto-generated>
using System;
...
namespace ContentTypeTextNet.Pe.Bridge.Models.Data
{
    ...
    public readonly record struct CredentialId
    {
        ...
        /// </summary>
        [JsonConstructor]
        public CredentialId(System.Guid id)
        {
            Id = id;
        }
        ...
        /// 空ID。
        /// </summary>
        public static CredentialId Empty
        {
            get
            {
                return new CredentialId(default(System.Guid));
            }
        }
        ...
        /// <summary>
        /// <see cref="CredentialId"/>に変換。
        /// </summary>
        /// <param name="s">入力文字列。</param>
        /// <param name="result">変更成功。</param>
        /// <returns></returns>
        public static bool TryParse(string s, out CredentialId result)
        {
            if(System.Guid.TryParse(s, out var val)) {
                result = new CredentialId(val);
                return true;
            }
        ...
        /// <param name="s">入力文字列。</param>
        /// <returns></returns>
        public static CredentialId Parse(string s)
        {
            var id = System.Guid.Parse(s);
        ...
        {
            return new CredentialId(System.Guid.NewGuid());
        }
