        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            switch(initializer.RunMode) {
                ...
                case Models.Data.RunMode.CrashReport: {
                        ...
                        var options = new Standard.Base.Models.CommandLineSimpleConverter<CrashReport.Models.Data.CrashReportOptions>(new Standard.Base.Models.CommandLine(e.Args, false)).GetMappingData();
                        if(options == null) {
