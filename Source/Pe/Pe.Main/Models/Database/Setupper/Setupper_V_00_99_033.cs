...
namespace ContentTypeTextNet.Pe.Main.Models.Database.Setupper
{
    ...
    public class Setupper_V_00_99_033: SetupperBase
    {
        public Setupper_V_00_99_033(IIdFactory idFactory, IDatabaseStatementLoader statementLoader, ILoggerFactory loggerFactory)
        ...
        public override Version Version { get; } = new Version(0, 99, 33);
