...
namespace ContentTypeTextNet.Pe.Main.Models.Element.Setting
{
    public class PluginsSettingEditorElement: SettingEditorElementBase
    {
        ...
        internal async Task InstallLocalPluginAsync(FileInfo archiveFile)
        {
            ...
            var pluginInstallData = await PluginInstaller.InstallPluginArchiveAsync(pluginFileName, archiveFile, ext, true, InstallPluginItemsImpl.Select(i => i.Data), TemporaryDatabaseBarrier);
