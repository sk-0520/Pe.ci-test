...
namespace ContentTypeTextNet.Pe.Main.Models.Plugin.Addon
{
    ...
    {
        public BackgroundAddonKeyboardContext(IPluginIdentifiers pluginIdentifiers, Key key, bool isDown)
    ...
    {
        public BackgroundAddonMouseMoveContext(IPluginIdentifiers pluginIdentifiers, [PixelKind(Px.Device)] Point location)
            : base(pluginIdentifiers)
        {
            Location = location;
        }
