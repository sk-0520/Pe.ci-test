...
namespace ContentTypeTextNet.Pe.Main.ViewModels.LauncherItem
{
    ...
    {
        public LauncherScriptViewModel(LauncherItemElement model, Screen screen, IDispatcherWapper dispatcherWapper, ILauncherToolbarTheme launcherToolbarTheme, ILoggerFactory loggerFactory)
